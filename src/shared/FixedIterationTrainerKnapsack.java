 ...
 * @version 1.0
 */
public class FixedIterationTrainerKnapsack implements Trainer {
    ...
    public FixedIterationTrainerKnapsack(Trainer t, int iter) {
        trainer = t;
        iterations = iter;
    }

    public FixedIterationTrainerKnapsack(Trainer t, int iter, int N) {
        trainer = t;
        iterations = iter;
        n = N;
    }
